...
<li class="menu-item <?php if($uri->getSegment(2) == "order"){echo "active";}?> <?php if($uri->getSegment(2) == "inprogress"){echo "active";}?>  <?php if($uri->getSegment(2) == "history"){echo "active";}?>">
  <a href="<?= base_url("Home/order")?>" class="menu-link">
    ...
    <li class="menu-item <?php if($uri->getSegment(2) == "customer"){echo "active";}?> <?php if($uri->getSegment(2) == "Edit"){echo "active";}?>">
  <a href="<?= base_url("Home/customer")?>" class="menu-link">
...
"></i>
    ...
    <li class="menu-item <?php if($uri->getSegment(2) == "produk"){echo "active";}?> <?php if($uri->getSegment(2) == "EditP"){echo "active";}?> <?php if($uri->getSegment(2) == "tambahP"){echo "active";}?>">
  <a href="<?= base_url("Home/produk")?>" class="menu-link">
...
<li class="menu-item <?php if($uri->getSegment(2) == "admin"){echo "active";}?><?php if($uri->getSegment(2) == "petugas"){echo "active";}?><?php if($uri->getSegment(2) == "t_user"){echo "active";}?> ">
